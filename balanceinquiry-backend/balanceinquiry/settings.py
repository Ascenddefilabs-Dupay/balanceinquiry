"""
Django settings for balanceinquiry project.
...
SECRET_KEY = 'django-insecure-(5aqj!eq9ykc_s)6k1@*h#ijf^1*v9s(18tth5s*0rm&6dzhpv'
...
ROOT_URLCONF = 'balanceinquiry.urls'
...
WSGI_APPLICATION = 'balanceinquiry.wsgi.application'
